...
def make_dataset(dir, class_to_idx, extensions):
    ...
    i=1
    # print("dir:", dir)  dir: /media/user/1AD07E595CCB2146/zb/datasets/University-Release/test/gallery_satellite_160k
    for target in sorted(os.listdir(dir)):
        ...
        for root, _, fnames in sorted(os.walk(d)):
            # for university-1652
            # root:root: /media/user/1AD07E595CCB2146/zb/datasets/University-Release/test/query_street/0836

            # for 160k
            #root: /
            #fnames: 0014glkVbKvhDwz.webp
            # if i==1:
            #     print("root:", root[0])
                # print("_:", _)
            ...
            for fname in sorted(fnames):
                if has_file_allowed_extension(fname, extensions):
                    ...
                    #university-1652: item: ('/media/user/1AD07E595CCB2146/zb/datasets/University-Release/test/query_street/0827/2.jpg', 693)
                    # print("item:", item)
                    # print("path=",path)
                    images.append(item)
...
class customData(Data.Dataset):
    def __init__(self, root, transform = None, target_transform = None, loader = default_loader, rotate = 0, pad = 0):
        ...
        imgs = make_dataset(root, class_to_idx, IMG_EXTENSIONS)#root=test+文件名
        #print("")
        if len(imgs) == 0:
            raise(RuntimeError("Found 0 images in subfolders of: " + root + "\n"
                               "Supported image extensions are: " + ",".join(IMG_EXTENSIONS)))
