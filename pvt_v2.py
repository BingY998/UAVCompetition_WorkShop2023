...
class PyramidVisionTransformerV2(nn.Module):
    ...
    #             x = self.rga_att1(x)
    #         elif i == 2:
    #             xg_3 = self.model_drn.layer3(x)
    #             xg_4 = self.model_drn.layer4(xg_3)
    #         elif i == 3:
    #             # drn for part branch
    #             xp_3 = self.model_ft.layer3(x)
    #             xp_4 = self.model_ft.layer4(xp_3)
    #     return features_list.append(x)
...
# Test the model, before you train it.
    net = pvt_v2_b2(pretrained=True).cuda()
    net.load_state_dict(torch.load("pvt_v2_b2.pth"), strict=False)
    # m = timm.create_model('pvt_v2_b2', pretrained=True)
    # state_dict = load_state_dict_from_url('D://Pycharm/LPN-main/pvt_v2_b2.pth', progress=True)
